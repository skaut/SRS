 ...
 */
class Version20170817205227 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE mail_to_roles DROP FOREIGN KEY FK_60D5DEBFBF396750');
        $this->addSql('ALTER TABLE mail_to_roles ADD subject VARCHAR(255) NOT NULL, ADD text LONGTEXT NOT NULL, ADD datetime DATETIME NOT NULL, CHANGE id id INT AUTO_INCREMENT NOT NULL');
        $this->addSql('ALTER TABLE mail_to_user DROP FOREIGN KEY FK_B0C046E9BF396750');
        $this->addSql('ALTER TABLE mail_to_user ADD subject VARCHAR(255) NOT NULL, ADD text LONGTEXT NOT NULL, ADD datetime DATETIME NOT NULL, CHANGE id id INT AUTO_INCREMENT NOT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE mail_to_roles DROP subject, DROP text, DROP datetime, CHANGE id id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE mail_to_user DROP subject, DROP text, DROP datetime, CHANGE id id INT NOT NULL');
