...
class RouterFactory
{
    ...
    public function createRouter() : Nette\Application\IRouter
    {
        ...
        $router[] = new Route(
            'admin/cms/<presenter>/<action>[/<id>][/<area>]',
            [
            'module' => 'Admin:CMS',
            'presenter' => 'Page',
            'action' => 'default',
        ...
        $router[] = new Route(
            'admin/program/<presenter>/<action>[/<id>]',
            [
        ...
        $router[] = new Route(
            'admin/payments/<presenter>/<action>[/<id>]',
            [
        ...
        $router[] = new Route(
            'admin/mailing/<presenter>/<action>[/<id>]',
            [
        ...
        $router[] = new Route(
            'admin/configuration/<presenter>/<action>[/<id>]',
            [
