...
{
    public function __construct(private readonly Translator $translator, private readonly DiscountRepository $discountRepository, private readonly DiscountService $discountService)
    {
    }
