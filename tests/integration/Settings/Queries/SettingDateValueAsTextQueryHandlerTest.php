...
final class SettingDateValueAsTextQueryHandlerTest extends CommandHandlerTest
{
    ...
    public function testGetValue(): void
    {
        ...
        $result = $this->queryBus->handle(new SettingDateValueAsTextQuery(self::ITEM));

        $this->assertEquals($value->format(Helpers::DATE_FORMAT), $result);
    }
    ...
    public function testGetValueNotExistingItem(): void
    {
        ...
        try {
            $this->queryBus->handle(new SettingDateValueAsTextQuery(self::ITEM));
    ...
    {
        $this->getModule('IntegrationTester')->useConfigFiles([__DIR__ . '/SettingDateValueAsTextQueryHandlerTest.neon']);
